        ...
        for token in tokens:
            ...
            if w_ner == "O":
                ...
                if(b_flag):
                    ...
                    res_sentence_disp += str(ans_index) + \
                        "\u00b7" + w.lower() + u"\uffe8B_ANS "
                ...
                if t_flag == 1:
                    ...
                    if ner == 'O':
                        ...
                        if flag == 0 and (j not in index_arr):
                            ...
                            res_sentence += w.lower() + u"\uffe8O_ANS "
            res_sentence_arr.append({'index': ans_index,
                                     'original_sentence': original_sentence,
                                     'tagged_sentence': res_sentence,
                                     'answer': res_ans})
            ans_index = ans_index+1

    i = i+1
res_sentence_arr_disp.append(
    {'disp_para': res_sentence_disp, 'backend_data': res_sentence_arr})
