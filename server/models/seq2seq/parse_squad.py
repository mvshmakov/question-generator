...
def parse_squad_dir():
    ...
    squad_train_filepath = './data/sberquad/train-v1.1.json'
    save_path = './data/sberquad/processed/parsed_train_data.json'
    ...
    squad_dev_filepath = './data/sberquad/dev-v1.1.json'
    save_path = './data/sberquad/processed/parsed_dev_data.json'
    ...
    train_filepath = './data/sberquad/processed/parsed_train_data.json'
    dev_filepath = './data/sberquad/processed/parsed_dev_data.json'
    ...
    def save_pickle(data, filename):
        ...
        save_documents = open('./data/sberquad/pickles/' +
                              filename + '.pickle', 'wb')
